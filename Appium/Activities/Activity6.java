...
public class Activity6 {
	...
	public void volume25Test() {
		...
		Dimension dims = driver.manage().window().getSize();
		// Set the start and end points
		Point start = new Point((int) (dims.getWidth() * .50), (int) (dims.getHeight() * .77));//this is to move 50% to 75% and as decimals is not accepted hence converted to int
		Point end = new Point((int) (dims.getWidth() * .34), (int) (dims.getHeight() * .77));
		// Perform swipe
